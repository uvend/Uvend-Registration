...
import { Youch } from 'file://C:/Users/Ross/OneDrive/Documents/UvendRegistrationfinal/Uvend-Registration/node_modules/youch/build/index.js';
...
const _mTchujhN7srBJ3FcJ7wfzqymtYwL1GI6takWjVzNMo = (nitroApp) => {
...
_mTchujhN7srBJ3FcJ7wfzqymtYwL1GI6takWjVzNMo
];

const assets = {
  "/index.mjs": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"1f702-xwPT7wHWTMSWLcg0cV/D5P1DxmI\"",
    "mtime": "2026-03-05T08:17:31.494Z",
    "size": 128770,
    "path": "index.mjs"
  },
  "/index.mjs.map": {
    "type": "application/json",
    "etag": "\"7c878-7wQOgTgIW6x3iPhqXjy/jTD6Leo\"",
    "mtime": "2026-03-05T08:17:31.494Z",
    "size": 510072,
    "path": "index.mjs.map"
  }
...
const _lazy_yxPbj2 = () => Promise.resolve().then(function () { return renderer$1; });
...
const handlers = [
  ...
  { route: '/__nuxt_error', handler: _lazy_yxPbj2, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_yxPbj2, lazy: true, middleware: false, method: undefined }
];
...
const buildRegistrationDetailsEmail = (payload) => {
  ...
  const html = `
    <div style="font-family: Arial, sans-serif; max-width: 720px; margin: 0 auto; padding: 20px; color: #111827;">
      ...
      <div style="padding: 14px; border: 1px solid #e5e7eb; border-radius: 10px; margin-bottom: 14px;">
        ...
        <div><strong>Installer Name:</strong> ${escapeHtml((address == null ? void 0 : address.installerName) || "Not provided")}</div>
        <div><strong>Installer Contact Number:</strong> ${escapeHtml((address == null ? void 0 : address.installerPhone) || "Not provided")}</div>
        <div><strong>Installer Email Address:</strong> ${escapeHtml((address == null ? void 0 : address.installerEmail) || "Not provided")}</div>
      </div>
  ...
  textLines.push(`- Installer Name: ${(address == null ? void 0 : address.installerName) || "Not provided"}`);
  textLines.push(`- Installer Contact Number: ${(address == null ? void 0 : address.installerPhone) || "Not provided"}`);
  textLines.push(`- Installer Email Address: ${(address == null ? void 0 : address.installerEmail) || "Not provided"}`);
  textLines.push("");
...
Installer Details
- Installer Name: ${(address == null ? void 0 : address.installerName) || "Not provided"}
- Installer Contact Number: ${(address == null ? void 0 : address.installerPhone) || "Not provided"}
- Installer Email Address: ${(address == null ? void 0 : address.installerEmail) || "Not provided"}
...
const sendEmail_post = defineEventHandler(async (event) => {
  ...
  try {
    ...
    const to = (_b = (_a = formData.find((field) => field.name === "to")) == null ? void 0 : _a.data) == null ? void 0 : _b.toString();
    const subject = (_d = (_c = formData.find((field) => field.name === "subject")) == null ? void 0 : _c.data) == null ? void 0 : _d.toString();
    const body = (_f = (_e = formData.find((field) => field.name === "body")) == null ? void 0 : _e.data) == null ? void 0 : _f.toString();
    ...
    const mailOptions = {
      ...
      html: body.replace(/\n/g, "<br>"),
      attachments: pdfFile ? [{
        filename: `registration-summary-${(/* @__PURE__ */ new Date()).toISOString().split("T")[0]}.pdf`,
